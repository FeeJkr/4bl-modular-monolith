...
namespace App\Modules\Finances\Infrastructure\Domain\Invoice\Doctrine;

use App\Modules\Finances\Domain\Invoice\Invoice;
use App\Modules\Finances\Domain\Invoice\InvoiceId;
use App\Modules\Finances\Domain\Invoice\InvoiceRepository as InvoiceRepositoryInterface;

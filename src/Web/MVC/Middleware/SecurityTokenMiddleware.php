...
final class SecurityTokenMiddleware implements EventSubscriberInterface
{
    ...
    public function onKernelController(ControllerEvent $event): void
    {
        ...
        if (is_array($controller) && $this->isSecuredByTokenRoute($controller)) {
    ...
    private function isSecuredByTokenRoute(array $controller): bool
    {
